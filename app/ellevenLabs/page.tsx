<div className="text-center mb-8">
  ...
  <p className="text-gray-600 text-lg max-w-2xl mx-auto mb-8">
    A state-of-the-art AI voice technology platform that offers natural and
    expressive text-to-speech synthesis with multilingual capabilities
  </p>
</div>;
...
<div className="bg-white/50 backdrop-blur-sm rounded-xl shadow-lg p-8 mb-8 border border-gray-100">
  <p className="text-gray-600 leading-relaxed">
    ...
    revolutionizes text-to-speech synthesis. It offers incredibly natural and
    emotionally expressive voices across multiple languages. With its advanced
    AI models, users can clone voices, customize speech characteristics, and
    generate high-quality audio content for various applications including
    audiobooks, podcasts, and digital content creation. The platform combines
    ease of use with professional-grade voice generation capabilities.
  </p>
</div>;
