...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to marketofagents, 425 West 121st Street, NY
            10027.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Market of Agents, accessible from{" "}
            <a
              href="https://www.marketofagents.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.marketofagents.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: fv2252@columbia.edu</li>
      </ul>
    </>
  );
}
